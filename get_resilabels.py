...
def main(argv=None):
    ...
    parser.add_argument('--ssm_filename', help="Path to a .dat output file generated by SSM's multiple sequence alignment tool")
    parser.add_argument('--output_dir', help="Directory where label files will be written")
